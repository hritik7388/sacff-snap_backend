 ...
 */
router.get("/getProjectScaffHold", authMiddleware_2.clientAuthMiddleware, authMiddleware_1.authMiddleware, subAdminControllers.getProjectScaffHold.bind(subAdminControllers));
/**
